...
def train():
    ...
    # saver.restore(sess,'model/vanilla_1024_500_epoch/epoch499.ckpt')
    ...
    for i in xrange(train_epoch_num):
        ...
        log_info('retrain_epoch {}: test accuracy {}'.format(i,test_correct_num/float(test_reader.total_size)))
